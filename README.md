...
-- [[ PRISON LIFE LOADSTRING SYSTEMS - CORRIGIDO ]]
local PrisonLife = {
...
-- Sistema de ESP Players - CORRIGIDO
function PrisonLife:ToggleESP_Players(state)
    ...
    if state then
        if not self.ESP_Players_Active then
            task.spawn(function()
                -- Primeiro tentar desativar qualquer ESP anterior
        ...
        if self.ESP_Players_Active then
            task.spawn(function()
                local success = pcall(function()
                    local url = GetLatestGitHubScript("https://raw.githubusercontent.com/Mickey123m/Vortex-Hub/refs/heads/main/Models/PrisonLife/ESP_REMOVE/ESP_RemoveESPPlayers")
                ...
                if success then
                    ...
                    -- Limpeza manual se o script falhar
...
-- Sistema de ESP Bandits - CORRIGIDO
function PrisonLife:ToggleESP_Bandits(state)
    ...
    if state then
        ...
        if self.ESP_Bandits_Active then
            task.spawn(function()
                local success = pcall(function()
                    local url = GetLatestGitHubScript("https://raw.githubusercontent.com/Mickey123m/Vortex-Hub/refs/heads/main/Models/PrisonLife/ESP_REMOVE/ESP_RemoveESPBandits")
                    loadstring(game:HttpGet(url, true))()
                end)
...
-- Sistema de ESP Polices - CORRIGIDO
function PrisonLife:ToggleESP_Polices(state)
    ...
    if state then
        ...
        if self.ESP_Polices_Active then
            task.spawn(function()
                local success = pcall(function()
                    local url = GetLatestGitHubScript("https://raw.githubusercontent.com/Mickey123m/Vortex-Hub/refs/heads/main/Models/PrisonLife/ESP_REMOVE/ESP_RemoveESPPolices")
                    loadstring(game:HttpGet(url, true))()
                end)
...
-- Sistema de ESP Prisoners - CORRIGIDO
function PrisonLife:ToggleESP_Prisoners(state)
    ...
    if state then
        ...
        if self.ESP_Prisoners_Active then
            task.spawn(function()
                local success = pcall(function()
                    local url = GetLatestGitHubScript("https://raw.githubusercontent.com/Mickey123m/Vortex-Hub/refs/heads/main/Models/PrisonLife/ESP_REMOVE/ESP_RemoveESPPrisoners")
                    loadstring(game:HttpGet(url, true))()
                end)
...
function PrisonLife:ToggleBypassDoors(state)
    ...
    if state then
        ...
        if self.BypassDoors_Active then
            task.spawn(function()
                local success = pcall(function()
                    local url = GetLatestGitHubScript("https://raw.githubusercontent.com/Mickey123m/Vortex-Hub/refs/heads/main/Models/PrisonLife/UTILITIES_REMOVE/UTILITIES_RemoveBypassDoors")
                    loadstring(game:HttpGet(url, true))()
                end)
...
function PrisonLife:ToggleAutoKeyCard(state)
    ...
    if state then
        ...
        if self.AutoKeyCard_Active then
            task.spawn(function()
                local success = pcall(function()
                    local url = GetLatestGitHubScript("https://raw.githubusercontent.com/Mickey123m/Vortex-Hub/refs/heads/main/Models/PrisonLife/UTILITIES_REMOVE/UTILITIES_RemoveAutoKeyCard")
                    loadstring(game:HttpGet(url, true))()
                end)
                
                if success then
                    self.AutoKeyCard_Active = false
                    print("[Vortex Hub] Prison Life: Auto KeyCard desativado!")
                end
            end)
        end
    end
...
function PrisonLife:ToggleAutoM9(state)
    ...
    if state then
        ...
        if self.AutoM9_Active then
            task.spawn(function()
                local success = pcall(function()
                    local url = GetLatestGitHubScript("https://raw.githubusercontent.com/Mickey123m/Vortex-Hub/refs/heads/main/Models/PrisonLife/UTILITIES_REMOVE/UTILITIES_RemoveAutoM9")
                    loadstring(game:HttpGet(url, true))()
                end)
                
                if success then
                    self.AutoM9_Active = false
                    print("[Vortex Hub] Prison Life: Auto M9 desativado!")
                end
            end)
        end
    end
...
function Westbound:ToggleESP_Players(state)
    ...
    if state then
        ...
        if self.ESP_Players_Active then
            task.spawn(function()
                local success = pcall(function()
                    local url = GetLatestGitHubScript("https://raw.githubusercontent.com/Mickey123m/Vortex-Hub/refs/heads/main/Models/Westbound/ESP_REMOVE/ESP_RemoveESPPlayers")
                    loadstring(game:HttpGet(url, true))()
                end)
...
function Westbound:ToggleESP_Animals(state)
    ...
    if state then
        ...
        if self.ESP_Animals_Active then
            task.spawn(function()
                local success = pcall(function()
                    local url = GetLatestGitHubScript("https://raw.githubusercontent.com/Mickey123m/Vortex-Hub/refs/heads/main/Models/Westbound/ESP_REMOVE/ESP_RemoveESPAnimals")
                    loadstring(game:HttpGet(url, true))()
                end)
...
function Westbound:ToggleESP_DistanceName(state)
    ...
    if state then
        ...
        if self.ESP_DistanceName_Active then
            task.spawn(function()
                local success = pcall(function()
                    local url = GetLatestGitHubScript("https://raw.githubusercontent.com/Mickey123m/Vortex-Hub/refs/heads/main/Models/Westbound/ESP_REMOVE/ESP_RemoveESPDistanceEName")
                    loadstring(game:HttpGet(url, true))()
                end)
...
function Westbound:ToggleESP_Name(state)
    ...
    if state then
        ...
        if self.ESP_Name_Active then
            task.spawn(function()
                local success = pcall(function()
                    local url = GetLatestGitHubScript("https://raw.githubusercontent.com/Mickey123m/Vortex-Hub/refs/heads/main/Models/Westbound/ESP_REMOVE/ESP_RemoveESPName")
                    loadstring(game:HttpGet(url, true))()
                end)
...
function FNAF:ApplyESP_Animatronics(state)
    States.FNAF_ESP_Animatronics = state
...
-- [[ PRISON LIFE CONFIGURATION - CORRIGIDO ]]
...
-- [[ FNAF: ETERNAL NIGHTS CONFIGURATION ]]
...
print("[Vortex Hub] PROBLEMAS CORRIGIDOS:")
print("[Vortex Hub] 1. ESPs Prison Life agora funcionam corretamente")
print("[Vortex Hub] 2. Sistema de cache para scripts evitando conflitos")
print("[Vortex Hub] 3. Botão fechar funciona")
print("[Vortex Hub] 4. Todos os loadstrings usam cache buster")
print("[Vortex Hub] 5. Sistema completo e funcional!")

dentro desse hub, existe esses scripts, quero que troque todos os coamndos dele para essas loadstrings, isso vai servir para diminuir linhas de códigos. Faça isso para o jogo "Prison Life"

ESP_Players: loadstring(game:HttpGet("https://raw.githubusercontent.com/Mickey123m/Vortex-Hub/refs/heads/main/Games/PrisonLife/ESP/ESP_Players"))()

ESP_Bandits: loadstring(game:HttpGet("https://raw.githubusercontent.com/Mickey123m/Vortex-Hub/refs/heads/main/Games/PrisonLife/ESP/ESP_Bandits"))()

ESP_Polices: loadstring(game:HttpGet("https://raw.githubusercontent.com/Mickey123m/Vortex-Hub/refs/heads/main/Games/PrisonLife/ESP/ESP_Polices"))()

ESP_Prisoners: loadstring(game:HttpGet("https://raw.githubusercontent.com/Mickey123m/Vortex-Hub/refs/heads/main/Games/PrisonLife/ESP/ESP_Polices"))()

PRISON_GetAK: loadstring(game:HttpGet("https://raw.githubusercontent.com/Mickey123m/Vortex-Hub/refs/heads/main/Games/PrisonLife/PRISONITEMS/PRISON_GetAK"))()

PRISON_GetMp5: loadstring(game:HttpGet("https://raw.githubusercontent.com/Mickey123m/Vortex-Hub/refs/heads/main/Games/PrisonLife/PRISONITEMS/PRISON_GetMp5"))()

PRISON_GetShotgun: loadstring(game:HttpGet("https://raw.githubusercontent.com/Mickey123m/Vortex-Hub/refs/heads/main/Games/PrisonLife/PRISONITEMS/PRISON_GetShotgun"))()

TELEPORT_CriminalSpawn: loadstring(game:HttpGet("https://raw.githubusercontent.com/Mickey123m/Vortex-Hub/refs/heads/main/Games/PrisonLife/TELEPORTS/TELEPORT_CriminalSpawn"))()

TELEPORT_InsidePrison: loadstring(game:HttpGet("https://raw.githubusercontent.com/Mickey123m/Vortex-Hub/refs/heads/main/Games/PrisonLife/TELEPORTS/TELEPORT_InsidePrison"))()

TELEPORT_OutPrison: loadstring(game:HttpGet("https://raw.githubusercontent.com/Mickey123m/Vortex-Hub/refs/heads/main/Games/PrisonLife/TELEPORTS/TELEPORT_OutPrison"))()

TELEPORT_YardCenter: loadstring(game:HttpGet("https://raw.githubusercontent.com/Mickey123m/Vortex-Hub/refs/heads/main/Games/PrisonLife/TELEPORTS/TELEPORT_YardCenter"))()

TELEPORT_PoliceCenter: loadstring(game:HttpGet("https://raw.githubusercontent.com/Mickey123m/Vortex-Hub/refs/heads/main/Games/PrisonLife/TELEPORTS/TELEPORT_PoliceCenter"))()

UTILITIES_AutoKeyCard: loadstring(game:HttpGet("https://raw.githubusercontent.com/Mickey123m/Vortex-Hub/refs/heads/main/Games/PrisonLife/UTILITIES/UTILITIES_AutoKeyCard"))()

UTILITIES_AutoM9: loadstring(game:HttpGet("https://raw.githubusercontent.com/Mickey123m/Vortex-Hub/refs/heads/main/Games/PrisonLife/UTILITIES/UTILITIES_AutoM9"))()

UTITLITIES_BypassDoors: loadstring(game:HttpGet("https://raw.githubusercontent.com/Mickey123m/Vortex-Hub/refs/heads/main/Games/PrisonLife/UTILITIES/UTILITIES_BypassDoors"))()