...
local function GetLatestGitHubScript(url)
    -- Gera um número único baseado no tempo e random
    local timestamp = math.floor(tick() * 1000) -- Milissegundos
    local random = math.random(10000, 99999) -- Número aleatório
    local cacheBuster = "?v=" .. timestamp .. "_" .. random
    
    -- Verifica se URL já tem parâmetros
    local fullUrl = url
    ...
    print("[GitHub Cache Buster] Carregando: " .. url .. " (timestamp: " .. timestamp .. ")")
    return fullUrl
end

-- [[ FUNÇÃO PARA LOADSTRING COM CACHE BUSTER ]]
local function LoadGitHubScript(url)
    ...
    if not success then
        warn("[Vortex Hub] Erro ao carregar script do GitHub: " .. tostring(result))
        return false
    end
...
-- [[ WESTBOUND SYSTEMS - COM CACHE BUSTER ]]
local Westbound = {
...
-- Sistema de ESP para Players usando scripts específicos COM CACHE BUSTER
    ...
    if state then
        ...
        if not self.ESP_Players_Active then
            local success, result = pcall(function()
                ...
                print("[Vortex Hub] Westbound: ESP Players ativado com sucesso! (Cache Buster Ativo)")
            end)
        ...
        if self.ESP_Players_Active then
            local success, result = pcall(function()
                ...
                loadstring(game:HttpGet(url, true))()
                print("[Vortex Hub] Westbound: ESP Players desativado (Cache Buster Ativo)")
            end)
...
-- Sistema de ESP para Animals usando scripts específicos COM CACHE BUSTER
    ...
    if state then
        ...
        if not self.ESP_Animals_Active then
            local success, result = pcall(function()
                ...
                loadstring(game:HttpGet(url, true))()
                print("[Vortex Hub] Westbound: ESP Animals ativado com sucesso! (Cache Buster Ativo)")
            end)
        ...
        if self.ESP_Animals_Active then
            local success, result = pcall(function()
                ...
                loadstring(game:HttpGet(url, true))()
                print("[Vortex Hub] Westbound: ESP Animals desativado (Cache Buster Ativo)")
            end)
...
-- Sistema de ESP Distance + Name usando scripts específicos COM CACHE BUSTER
    ...
    if state then
        ...
        if not self.ESP_DistanceName_Active then
            local success, result = pcall(function()
                ...
                loadstring(game:HttpGet(url, true))()
                print("[Vortex Hub] Westbound: ESP Distance + Name ativado com sucesso! (Cache Buster Ativo)")
            end)
        ...
        if self.ESP_DistanceName_Active then
            local success, result = pcall(function()
                ...
                loadstring(game:HttpGet(url, true))()
                print("[Vortex Hub] Westbound: ESP Distance + Name desativado (Cache Buster Ativo)")
            end)
...
-- Sistema de ESP Name usando scripts específicos COM CACHE BUSTER
    ...
    if state then
        ...
        if not self.ESP_Name_Active then
            local success, result = pcall(function()
                ...
                loadstring(game:HttpGet(url, true))()
                print("[Vortex Hub] Westbound: ESP Name ativado com sucesso! (Cache Buster Ativo)")
            end)
        ...
        if self.ESP_Name_Active then
            local success, result = pcall(function()
                ...
                loadstring(game:HttpGet(url, true))()
                print("[Vortex Hub] Westbound: ESP Name desativado (Cache Buster Ativo)")
            end)
...
print("[Vortex Hub] Westbound - Sistema ESP corrigido com CACHE BUSTER")
print("[Vortex Hub] Westbound - Todos os scripts do GitHub agora usam cache buster para atualização forçada")
...
print("[Vortex Hub] Sistema 100% funcional - Cache Buster ativo em TODOS os scripts do GitHub!")
print("[Vortex Hub] Agora cada carregamento forçará a versão mais atualizada do seu repositório!")
